        ...
        public static void EnsureSeedDataForContext(this LibraryContext context)
        {
            ...
            var authors = new List<Author>()
            {
                new Author()
                {
                     ...
                     Contacts = new List<AuthorContact>()
                     {
                         new AuthorContact()
                         {
                             Id = new Guid("710c9ddd-b4f3-4705-8ca1-7add7be15af0"),
                             Type = ContactType.Email,
                             Contact = "email@email.com"
                         },
                         new AuthorContact()
                         {
                             Id = new Guid("ca6c71de-334c-4724-96d3-e7c42d73f356"),
                             Type = ContactType.Phone,
                             Contact = "11 9 8858-1633"
                         },
                         new AuthorContact()
                         {
                             Id = new Guid("6ceb6430-2135-4575-a91a-387fce305b12"),
                             Type = ContactType.SocialNetwork,
                ...
                new Author()
                {
                     ...
                     Contacts = new List<AuthorContact>()
                     {
                         new AuthorContact()
                         {
                             Id = new Guid("f9ad353c-dc47-49c5-a595-ff95e137c82e"),
                             Type = ContactType.Email,
                             Contact = "email1@email.com"
                         },
                         new AuthorContact()
                         {
                             Id = new Guid("c9452c6c-1e75-4ee3-84bd-d77a9fc360d7"),
                             Type = ContactType.Phone,
                             Contact = "11 9 8858-1634"
                         },
                         new AuthorContact()
                         {
                             Id = new Guid("2378d8d5-717a-4a04-ad91-ffb038a78691"),
                             Type = ContactType.SocialNetwork,
                             Contact = "facebook1.com"
                         },
                     }
                },
                new Author()
                {
                     ...
                     Contacts = new List<AuthorContact>()
                     {
                         new AuthorContact()
                         {
                             Id = new Guid("a5c5336e-c61e-40be-bb59-68511c394e9d"),
                             Type = ContactType.Phone,
                             Contact = "11 9 8858-1635"
                         },
                     }
                },
                new Author()
                {
                     ...
                     Contacts = new List<AuthorContact>()
                     {
                         new AuthorContact()
                         {
                             Id = new Guid("97fcc4f2-7d79-4963-948e-ec0df408eb02"),
                             Type = ContactType.SocialNetwork,
                             Contact = "facebook35.com"
                         },
                     }
                },
                new Author()
                {
                     ...
                     Contacts = new List<AuthorContact>()
                     {
                         new AuthorContact()
                         {
                             Id = new Guid("ed92af78-7264-441d-aa82-bbd327b05c53"),
                             Type = ContactType.Email,
                             Contact = "email37@email.com"
                         },
                         new AuthorContact()
                         {
                             Id = new Guid("9c821400-1010-4eb7-94fa-34d3e256b029"),
                             Type = ContactType.Phone,
                             Contact = "11 9 8858-1733"
                         },
                         new AuthorContact()
                         {
                             Id = new Guid("efe7f42b-125f-465a-add8-b78edc037360"),
                             Type = ContactType.SocialNetwork,
                             Contact = "facebook900.com"
                         },
                     }
                },
                new Author()
                {
                     ...
                     Books = new List<Book>()
                     {
                         new Book()
                         {
                             Id = new Guid("37295276-20a8-4147-bd25-84e9a3e93f62"),
                             Title = "Easy Money",
